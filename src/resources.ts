// MCP Resource Handlers for the Ironscales MCP Server
  ...
  return [
    {
      ...
      name: 'Ironscales Incident Card',
      description: 'Interactive MCP Apps card rendering an Ironscales phishing incident',
